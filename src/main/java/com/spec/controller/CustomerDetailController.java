...
import com.spec.dto.SalaryRange;
...
public class CustomerDetailController {
	...
	public CustomerDetailResDTO updateCustomerDetail(@RequestBody CustomerDetailReqDTO customerDetailReqDTO)
	...
	public Map getCustomerDetailBySearchCriteria(
			@RequestBody CustomerDetailSearchOperation customerDetailSearchOperation) throws ServiceException {
	...
	public List<CustomerDetail> findByFirstNameAndLastName(@PathVariable Long page, @PathVariable Long offset,
	...
	public CustomerDetailResDTO getCustomerDetailByIdCache(@PathVariable Long customerDetailId)
			throws ServiceException {
		log.info("inside CustomerDetailController, getCustomerDetailById method called !!");
	...
	public String saveExcelFile(@RequestParam("file") MultipartFile file) throws IOException, ServiceException {
		if (ExcelHelper.checkExcelFormat(file)) {
			...
			ServiceError serviceError = new ServiceError(ErrorConstant.EXCEL_FORMAT,
					ErrorConstant.EXCEL_FORMAT_EXCEPTION);
	...
	public List<CustomerDetail> findBySalaryRange(@RequestBody SalaryRange salaryRange) {
		return customerDetailRepository.findSalaryBasedOnRange(salaryRange.getFirstName(), salaryRange.getStartRange(),
				salaryRange.getEndRange(), salaryRange.getStartDate(), salaryRange.getEndDate());
	}
